...
export default function About() {
  return (
    <section className="relative text-gray-600 body-font bg-white">
    <div className="px-5 py-40 mx-auto">
      <div className="flex flex-col text-center w-full mb-20">
        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-stone-800">Cada día más cerca de nuestros clientes</h1>
      ...
      <div className="flex flex-wrap -m-4 text-center">
        <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
          <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="text-slate-800 transition duration-700 hover:text-secondary-100 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
